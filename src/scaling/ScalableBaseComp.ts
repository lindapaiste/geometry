 ...
 */
export default class ScalableBase<Scalable extends string, OT extends Record<Scalable, number> & I_Scalable> implements I_ScalableObject<Scalable, OT> {
    /**
     ...
     * "It supports symbols but isn't perfect for getters/setters and isn't working with non-enumerable properties (see
     * Object.assign() docs).
     */
    ...
    /**
     * @param {object} limits is an object where the keys are the property names and the values are the maximum value
     *     for that property
     */

    scaleToFit(limits: Limits<Scalable>): OT {
    ...
    /**
     * @param {object} limits is an object where the keys are the property names and the values are the minimum value
     *     for that property
     */
    scaleToCover(limits: Limits<Scalable>): OT {
