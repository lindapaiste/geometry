...
// ----------------------------STRETCHING--------------------------//
    ...
    stretchToWidth = (width: number, fixedProperty?: XNames): ImmutableRectangle => {
        return this.stretchBack(this.rectangle.stretchToWidth(width, fixedProperty));
    };

    stretchToHeight = (height: number, fixedProperty?: YNames): ImmutableRectangle => {
