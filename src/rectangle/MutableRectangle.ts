 ...
 *
 * does not have all of the methods of the ImmutableRectangle class, but it can pass itself to that constructor to access them
 */
...
//----------------------------SET VALUES: MOVE--------------------------//
     ...
     */
    set center(point: RectanglePoint) {
        this.xmid = point.x;
        this.ymid = point.y;
    }
